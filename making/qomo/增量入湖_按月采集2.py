...
class ZLRH2Config(ConnectExtend):
    ...
    GENERATOR = QomoSqlGenerator("zlrh_month_0912_1", comment="增量入湖月采集测试表_0912_1").fields(
    ...
    def case1(self):
        data = list()
        data.append(["1", "18", "张三", "男", "000001", "170", "70", '2024-07-01 00:00:00'])
        data.append(["2", "18", "李四", "男", "000002", "170", "70", '2024-07-31 00:00:00'])
        data.append(["3", "18", "王五", "男", "000003", "170", "70", '2024-07-09 00:00:00'])
        data.append(["4", "18", "赵六", "男", "000004", "170", "70", '2024-08-01 00:00:00'])
        data.append(["5", "18", "孙七", "男", "000005", "170", "70", '2024-08-31 00:00:00'])
        data.append(["6", "18", "刘八", "男", "000006", "170", "70", '2024-08-09 00:00:00'])
        ...
        data.append(["10", "18", "增量刘八", "男", "000009", "170", "70", '2024-09-11 00:00:00'])
        data.append(["11", "18", "增量刘八", "男", "000009", "170", "70", '2024-09-11 00:00:00'])
...
class ZLRH3Config(ConnectExtend):
    ...
    """
    CONNECT = MysqlConnect(QomoConf)
    GENERATOR = QomoSqlGenerator("zlrh_month_0912_2", comment="增量入湖月采集测试表_0912_2").fields(
                                                Varchar(name='field1', comment='年龄'),
                                                Varchar(name='field2', comment='姓名'),
                                                Varchar(name='field3', comment='性别'),
                                                Varchar(name='field4', comment='编号'),
