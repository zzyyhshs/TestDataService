...
class ZLRH2Config(ConnectExtend):
    ...
    GENERATOR = QomoSqlGenerator("zlrh_0911_2", comment="增量入湖测试表_2").fields(
...
class ZLRH3Config(ConnectExtend):
    ...
    """
    CONNECT = MysqlConnect(QomoConf)
    GENERATOR = QomoSqlGenerator("zlrh_0911_3", comment="增量入湖测试表_3").fields(
                                                Varchar(name='field1', comment='年龄'),
                                                Varchar(name='field2', comment='姓名'),
                                                Varchar(name='field3', comment='性别'),
                                                Varchar(name='field4', comment='编号'),
    ...
    def case1(self):
        ...
        # data.append(["5", "18", "孙七", "男", "000005", "170", "70", '2022-01-01 00:00:00'])
        # data.append(["6", "18", "刘八", "男", "000006", "170", "70", '2022-01-01 00:00:00'])
        data.append(["1", "18", "张三", "男", "000007", "170", "70", '2024-09-09 00:00:00'])
        data.append(["2", "18", "李四", "男", "000008", "170", "70", '2024-09-10 00:00:00'])
        data.append(["3", "18", "王五", "男", "000009", "170", "70", '2024-09-10 00:00:00'])
        data.append(["4", "18", "增量刘八", "男", "000009", "170", "70", '2024-09-11 00:00:00'])
        data.append(["5", "18", "增量刘八", "男", "000009", "170", "70", '2024-09-11 00:00:00'])
        data.append(["6", "18", "增量刘八", "男", "000009", "170", "70", '2024-09-12 00:00:00'])
        self.create_data(data)
